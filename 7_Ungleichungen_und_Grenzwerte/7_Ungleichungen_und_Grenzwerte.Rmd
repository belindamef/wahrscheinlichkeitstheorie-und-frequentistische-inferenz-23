...
\footnotesize
\noindent Als nächstes definieren wir $\ups := (\xi - \mathbb{E}(\xi))^2$. Dann folgt aus der Markov Ungleichung
\tiny
\begin{align}
\begin{split}
...
* Für einen Beweis verweisen wir auf @degroot_2012, Theorem 4.6.2.
...
c(x_0,x_1,x_2)^2,
pch = 19)
dev.copy2pdf(file = "7_Abbildungen/wtfi_7_jensensche_ungleichung.pdf", width=5, height=5)   
```
...
knitr::include_graphics("7_Abbildungen/wtfi_7_jensensche_ungleichung.pdf")
```
\vspace{-4mm}
\footnotesize
...
* Für einen Beweis siehe zum Beispiel @georgii_2009, Abschnitt 5.1.
...
Wir verzichten hier aber auf die Angabe von Beweisen.
* In beiden Formulierungen des Zentralen Grenzwertsatzes ist die betrachtete
Konvergenz von Zufallsvariablen die *Konvergenz in Verteilung*, welche
wir zunächst einführen.
* Zur mathematik-geschichtlichen Genese der Zentralen Grenzwertsätze siehe z.B. @fischer_2011.
